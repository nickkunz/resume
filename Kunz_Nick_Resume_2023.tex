...
\fontdimen2\font = 1pt
    \begin{bgbox}[
        ...
        \textcolor{white}{
            ...
            \section*{Skills}
                Synthetic Data, Machine Learning, Statistics\newline
            ...
            \section*{Frameworks}
                ...
                \textbf{Prompt Engineering}: OpenAI, LLaMa\newline
                \textbf{Data Visualization}: Streamlit, Seaborn
            \section*{Deployment}
    ...
    \begin{bgbox}[
        ...
        \textcolor{black}{
            \section*{Experience}
                ...
                Technical lead on the development and deployment of machine learning services for grant funding and administration in clinical research and public health. Detailed analyses of PubMed Knowledge Graph utilized for marketing managed services in support of awarded contract for research support. Firm service on LLM applications for AI quality.\newline\newline
